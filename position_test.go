...
func TestConstants(t *testing.T) {
	...
	Convey("Constants Set Correctly", t, func() {
		So(A8, ShouldEqual, Square(1))
		So(B8, ShouldEqual, Square(1<<1))
		So(C8, ShouldEqual, Square(1<<2))
		So(D8, ShouldEqual, Square(1<<3))
		So(E8, ShouldEqual, Square(1<<4))
		So(F8, ShouldEqual, Square(1<<5))
		So(G8, ShouldEqual, Square(1<<6))
		So(H8, ShouldEqual, Square(1<<7))
		So(A7, ShouldEqual, Square(1<<8))
		So(B7, ShouldEqual, Square(1<<9))
		So(C7, ShouldEqual, Square(1<<10))
		So(D7, ShouldEqual, Square(1<<11))
		So(E7, ShouldEqual, Square(1<<12))
		So(F7, ShouldEqual, Square(1<<13))
		So(G7, ShouldEqual, Square(1<<14))
		So(H7, ShouldEqual, Square(1<<15))
		So(A6, ShouldEqual, Square(1<<16))
		So(B6, ShouldEqual, Square(1<<17))
		So(C6, ShouldEqual, Square(1<<18))
		So(D6, ShouldEqual, Square(1<<19))
		So(E6, ShouldEqual, Square(1<<20))
		So(F6, ShouldEqual, Square(1<<21))
		So(G6, ShouldEqual, Square(1<<22))
		So(H6, ShouldEqual, Square(1<<23))
		So(A5, ShouldEqual, Square(1<<24))
		So(B5, ShouldEqual, Square(1<<25))
		So(C5, ShouldEqual, Square(1<<26))
		So(D5, ShouldEqual, Square(1<<27))
		So(E5, ShouldEqual, Square(1<<28))
		So(F5, ShouldEqual, Square(1<<29))
		So(G5, ShouldEqual, Square(1<<30))
		So(H5, ShouldEqual, Square(1<<31))
		So(A4, ShouldEqual, Square(1<<32))
		So(B4, ShouldEqual, Square(1<<33))
		So(C4, ShouldEqual, Square(1<<34))
		So(D4, ShouldEqual, Square(1<<35))
		So(E4, ShouldEqual, Square(1<<36))
		So(F4, ShouldEqual, Square(1<<37))
		So(G4, ShouldEqual, Square(1<<38))
		So(H4, ShouldEqual, Square(1<<39))
		So(A3, ShouldEqual, Square(1<<40))
		So(B3, ShouldEqual, Square(1<<41))
		So(C3, ShouldEqual, Square(1<<42))
		So(D3, ShouldEqual, Square(1<<43))
		So(E3, ShouldEqual, Square(1<<44))
		So(F3, ShouldEqual, Square(1<<45))
		So(G3, ShouldEqual, Square(1<<46))
		So(H3, ShouldEqual, Square(1<<47))
		So(A2, ShouldEqual, Square(1<<48))
		So(B2, ShouldEqual, Square(1<<49))
		So(C2, ShouldEqual, Square(1<<50))
		So(D2, ShouldEqual, Square(1<<51))
		So(E2, ShouldEqual, Square(1<<52))
		So(F2, ShouldEqual, Square(1<<53))
		So(G2, ShouldEqual, Square(1<<54))
		So(H2, ShouldEqual, Square(1<<55))
		So(A1, ShouldEqual, Square(1<<56))
		So(B1, ShouldEqual, Square(1<<57))
		So(C1, ShouldEqual, Square(1<<58))
		So(D1, ShouldEqual, Square(1<<59))
		So(E1, ShouldEqual, Square(1<<60))
		So(F1, ShouldEqual, Square(1<<61))
		So(G1, ShouldEqual, Square(1<<62))
		So(H1, ShouldEqual, Square(1<<63))
	})
}
